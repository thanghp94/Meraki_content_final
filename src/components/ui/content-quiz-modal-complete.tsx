      ...
      <DialogContent className="max-w-7xl w-full h-[90vh] p-0 bg-gray-50">
        <div className="flex flex-col h-full">
          ...
          <div className="flex flex-col bg-white border-b">
            ...
            {showFeedback && (
              <div className={`mx-6 mb-4 p-3 rounded-lg border-2 shadow-lg ${
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            {/* Question Content Area - Top 50% */}
            <div className="h-1/2 p-4 md:p-6 overflow-hidden">
            ...
            {/* Answer Choices Area - Bottom 50% */}
            <div className="h-1/2 p-4 md:p-6 flex items-center justify-center">
              <div className="w-full max-w-6xl">
                {/* Always 4 cards in a row, but only show available choices */}
                  ...
                  {availableChoices.map((choice) => {
                    ...
                    return (
                      <button
                        ...
                        className={`p-3 md:p-4 rounded-lg border-2 text-left transition-all relative h-20 md:h-24 ${
                          showCorrect
