    ...
    case 'image':
      return (
        <img 
          ...
          style={{ 
            maxHeight: isCompact ? '80px' : '200px', 
            objectFit: 'cover',
    ...
    case 'video':
      return (
        <video 
          ...
          controls 
          className={`max-w-full h-auto rounded-lg ${className}`}
          style={{ maxHeight: isCompact ? '80px' : '200px' }}
        >
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-6 bg-white border-b">
            ...
            <div className="flex items-center gap-3">
              {/* Action Buttons - Moved to header and made thinner */}
              <Button
                variant="outline"
                size="sm"
                onClick={handleShowContent}
                className="bg-purple-600 text-white border-purple-600 hover:bg-purple-700 px-3 py-1 h-7 text-xs font-medium"
              >
                Show Content
              </Button>
              ...
              <Button
                ...
                size="sm"
                className="bg-green-600 text-white hover:bg-green-700 disabled:bg-gray-400 px-3 py-1 h-7 text-xs font-medium flex items-center gap-1"
              >
          ...
          <div className="flex-1 overflow-hidden">
            <div className="p-8 h-full overflow-y-auto">
              <div className="max-w-5xl mx-auto">
                {/* Question Content - Above answer choices */}
                ...
                {/* Answer Choices - Adaptive Layout */}
                <div className={`mb-8 ${
                  hasImageAnswers 
                    ? 'grid grid-cols-4 gap-4' // 4 in a row for images
                    : 'grid grid-cols-2 gap-6' // 2x2 for text
                }`}>
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`p-4 rounded-lg border-2 text-left transition-all relative ${
                          hasImageAnswers ? 'min-h-[100px]' : 'min-h-[120px]'
                        } ${
                          showCorrect
