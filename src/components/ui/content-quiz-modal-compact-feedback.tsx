    ...
    case 'video':
      return (
        <video 
          ...
          controls 
          className={`max-w-full h-auto rounded-lg ${className}`}
          style={{ maxHeight: isCompact ? '60px' : '200px' }}
        >
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            <div className="flex-1 flex flex-col p-4 md:p-8 overflow-y-auto">
              <div className="max-w-5xl mx-auto flex-1 flex flex-col">
                ...
                {/* Answer Choices - Responsive Layout */}
                <div className={`${
                  hasImageAnswers 
                    ? 'grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4' // 2 cols on mobile, 4 on large screens for images
                    : 'grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6' // 1 col on mobile, 2x2 on larger screens for text
                }`}>
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`p-3 md:p-4 rounded-lg border-2 text-left transition-all relative ${
                          hasImageAnswers ? 'min-h-[80px] md:min-h-[100px]' : 'min-h-[100px] md:min-h-[120px]'
                        } ${
                          showCorrect
                      ...
                      >
                        <div className="flex items-start gap-2 md:gap-3 h-full">
                          ...
                          {showCorrect && (
                            <Check className="h-4 w-4 md:h-5 md:w-5 text-green-600 absolute top-2 md:top-4 right-2 md:right-4" />
                          )}
                          {showIncorrect && (
                            <X className="h-4 w-4 md:h-5 md:w-5 text-red-600 absolute top-2 md:top-4 right-2 md:right-4" />
                          )}
                        </div>
                      </button>
                    );
